...
android {
  ...
  defaultConfig {
    applicationId = "com.mojamgazi.voicesummaryai"
    minSdk = 30
    targetSdk = 36
    versionCode = 1
    versionName = "1.0"
...
dependencies {
  ...
  // AppLovin MAX SDK & Google Play Services Ads
  ...
  // implementation("com.arthenica:ffmpeg-kit-audio:6.0-2") // Requires specific repo
